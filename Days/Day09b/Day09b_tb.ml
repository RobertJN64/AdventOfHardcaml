...
let () =
  ...
  Cyclesim.reset sim;
  Cyclesim.cycle sim;
  SerialTB.send_serial_file sim "Days/Day09b/Day09b_input.txt"; (* send once for finding corners *)
  SerialTB.send_serial_string sim "\n"; (* sep *)
  SerialTB.send_serial_file sim "Days/Day09b/Day09b_input.txt"; (* send twice for finding limits *)
  SerialTB.send_serial_string sim "\n"; (* sep *)
  SerialTB.send_serial_file sim "Days/Day09b/Day09b_input.txt"; (* send thrice for finding area *)
  ...
  (* assert (answer_value = 1525241870); *)
